//Copyright 2019 and Patent Pending. 2020-07-01 15:13:10
var myNotificationID = null;
var redirectURL = null;
function natitNativeTest() {
  var msg = {title:gappTitle ? gappTitle : "Information!", iconUrl:"img/icon.png", message:"This is notification details and description", imageUrl:"http://cdn.sstatic.net/stackexchange/img/logos/so/so-icon.png", link:"http://stackoverflow.com/a/13328397/1269037"};
  nativeNotify(msg);
}
...
function nativeNotify(msgData) {
  ...
  msgData.iconUrl = msgData.iconUrl ? msgData.iconUrl : "img/icon.png";
  if (msgData.link) {
