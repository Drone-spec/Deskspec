...
(function(a) {
    a.widget("ui.multiOpenAccordion", {
        options: {
            ...
            hideAll: null ,
            _classes: {
                accordion: "exif-accordion exif-widget exif-helper-reset exif-accordion-icons",
                h3: "exif-accordion-header exif-helper-reset exif-state-default exif-corner-all",
                div: "exif-accordion-content exif-helper-reset exif-widget-content exif-corner-bottom",
                divActive: "exif-accordion-content-active",
                span: "exif-icon ui-icon-triangle-1-e",
                stateDefault: "exif-state-default",
                stateHover: ""
            }
        },
        _create: function() {
        ...
        destroy: function() {
            ...
            c.removeClass(e._classes.h3).removeClass("exif-state-default exif-corner-all exif-state-active exif-corner-top").children("span").remove();
            d.removeClass(e._classes.div + " " + e._classes.divActive).show()
        },
        _showTab: function(a) {
            var b = a.children("span.exif-icon");
            var c = a.next();
            var d = this.options;
            a.removeClass("exif-state-default exif-corner-all").addClass("exif-state-active exif-corner-top");
            b.removeClass("exif-icon-triangle-1-e").addClass("exif-icon-triangle-1-s");
        ...
        _hideTab: function(a) {
            ...
            var c = a.next();
            var d = this.options;
            a.removeClass("exif-state-active exif-corner-top").addClass("exif-state-default exif-corner-all");
            b.removeClass("exif-icon-triangle-1-s").addClass("exif-icon-triangle-1-e");
            b.css("display", "inline-block");
