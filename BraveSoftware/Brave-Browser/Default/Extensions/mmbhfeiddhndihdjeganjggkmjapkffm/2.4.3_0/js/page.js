var isOnUIPage = "UI_PAGE";  //Extra variable by Veeresh, only for notis.js to distinguish from BG/UI calls
...
var re = {
  ...
  PHOTO_URL: /^https?:\/\/farm\d+\.staticflickr\.com\/[^\/]+\/(\d+)_/i
};
